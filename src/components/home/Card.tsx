...
export default function Card({ url, title, likes, id, mode, mr = 3 }: CardProps) {
  const path = `/${mode}/${id}`;
  return (
    <Link to={path} className={`min-w-[122px] h-[148px] bg-no-repeat`} style={{ backgroundImage: `url(${url})`, marginRight: mr * 4 }}>
